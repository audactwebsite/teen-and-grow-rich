...
Note the hyphen — it is load-bearing. `teenandgrowrich.com` without it belongs to an
unrelated company, which is why the book was re-issued with the hyphenated address on the
QR codes, the Publishing Note, the author page and the back cover. The site already tells readers, in the footer and
